  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      <div className='absolute md:top-[20%] top-[5%] right-[45px] text-[white] '>
        <p className='md:text-[44px] text-[12px] md:text-left text-center font-[700] leading-none '>Fair and <br /> Accessible Prices</p>
       <div className='md:pt-[10px] pt-[5px] font-[600] md:text-left text-center md:text-[18px] text-[10px] ' >
        <p>DISCOVER A WIDE</p>
        <p>RANGE OF PREMIUM EQUIPMENT, </p>
        <p>DEVELOPED IN FRANCE</p>
        <p>BY ENTHUSIASTS</p>
        </div>
        ...
        <a href="/achievements">  <button className='bg-[#325897] font-[600] hover:bg-[#3B4042] text-white md:px-5 px-2 py-2 border-black border-[1px] md:text-[12px] text-[10px] ' >OUR ACHIEVEMENTS </button> </a>
